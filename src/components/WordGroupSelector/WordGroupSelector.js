  ...
  useEffect(() => {
    collectedWordGroupsService.all().then(function(collectedWordGroups) {
      ...
      setWordGroups({
        ...
        Colors: [collectedWordGroups[wordKeys.current[3]], "images/word-group/colors.svg"],
        Animals: [collectedWordGroups[wordKeys.current[4]], "images/word-group/animals-1.svg"],
        Transport: [collectedWordGroups[wordKeys.current[5]], "images/word-group/travel.svg"],
        "Body Parts": [collectedWordGroups[wordKeys.current[6]], "images/word-group/body.svg"],
        Clothing: [collectedWordGroups[wordKeys.current[7]], "images/word-group/clothes.svg"],
        Food: [collectedWordGroups[wordKeys.current[8]], "images/word-group/food-1.svg"],
        "More Food": [collectedWordGroups[wordKeys.current[9]], "images/word-group/food-2.svg"],
        Furniture: [collectedWordGroups[wordKeys.current[10]], "images/word-group/home.svg"],
        Emotion: [collectedWordGroups[wordKeys.current[11]], "images/word-group/emotions.svg"],
        Media: [collectedWordGroups[wordKeys.current[12]], "images/word-group/media.svg"],
        "More Animals": [collectedWordGroups[wordKeys.current[13]], "images/word-group/animals-2.svg"],
        "Even More Animals!": [collectedWordGroups[wordKeys.current[14]],"images/word-group/animals-3.svg"]
      });
    });
  }, []);
